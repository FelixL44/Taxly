...
const CapitalFormingBenefits: React.FC<{ onBack: () => void }> = () => {
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" sx={{ color: INACTIVE_COLOR, mb: 4, lineHeight: 1.6 }}>
        Vermögenswirksame Leistungen sind Leistungen, die der Arbeitgeber in einen von Ihnen gewählten Anlagevertrag e{' '}
        <Typography
          component="span"
            ...
            <Box>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                <Typography variant="body2" sx={{ fontWeight: 500, color: '#1E293B' }}>
                  Hat Ihr Arbeitgeber für Sie vermögenswirksame Leistungen (VL, vwL) angelegt?
                </Typography>
                <Tooltip
                  title="Vermögenswirksame Leistungen sind Arbeitgeberleistungen, die in einen Anlagevertrag (z.B. Bausparvertrag, Fonds) eingezahlt werden."
                  arrow
                >
              ...
              <RadioGroup
                row
                value={hasBenefits ? 'yes' : 'no'}
                onChange={(e) => setHasBenefits(e.target.value === 'yes')}
                sx={{
...
export default CapitalFormingBenefits;
